...
#
get_filename_component(filename "/home/yan/Downloads/openwrt/lede/build_dir/host/cmake-3.30.5/Tests/ExternalProjectLocal/Step1.tar.bz2" ABSOLUTE)
get_filename_component(directory "/home/yan/Downloads/openwrt/lede/build/Ext/Source/TutorialStep1-LocalBZ2" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-TutorialStep1-LocalBZ2${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-TutorialStep1-LocalBZ2${i}")
